...
const BouncingLogo: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      exit={{ left: 38, top: 30, scale: 1, opacity: 1, transition: { duration: 0.8, ease: "easeInOut" } }}
      transition={{ duration: 1.5, ease: "easeInOut" }}
      className="fixed z-[500] pointer-events-none select-none blend-difference origin-center"
...
const Header: React.FC<HeaderProps> = ({ onInquire, isIdle }) => {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 w-full z-[190] p-[30px] pointer-events-none transition-opacity duration-[1700ms] ease-in-out blend-difference ${isIdle ? 'opacity-0' : 'opacity-100'}`}>
